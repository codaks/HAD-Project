            ...
            <div className="iq-card" style={{backgroundColor: '#ceebee'}}>
                <div className="iq-card-body">
                    ...
                    <div className="text-center mt-3">
                        <div> <h4> <b>SENIOR DOCTOR</b> </h4> </div>
                        <div>
                            ...
                            <tr style={{color: '#000000'}}>
                                <td style={{textAlign: 'left'}}> Degree </td>
                                <td style={{textAlign: 'left'}}>MBBS</td>
                            </tr>
                            <tr style={{color: '#000000'}}>
...
export default SeniorDoctorProfile;